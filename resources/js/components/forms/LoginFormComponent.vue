<template>
  <div
    class="w-1/3 h-80 p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700"
  >
    <h3 class="font-bold text-3xl mb-4 text-center">Login</h3>
      <div class="mb-6">
        <label
          for="email"
